...
<body>
    <div class="container text-center mt-5">
        <h2 class="text-uppercase fw-bold text-danger">Our Pastoral Team</h2>
        <div class="row mt-4">
            <div class="col-md-4">
                <div class="pastor-card">
                    <img src="12.png" alt="Apostle Richard Udoh">
                    <h4>Apostle (Dr.) Richard Udoh</h4>
                    <p><em>Senior Pastor</em></p>
                    <p>Apostle (Dr.) Udoh is the Senior Pastor of The Father's House...</p>
            ...
            <div class="col-md-4">
                <div class="pastor-card">
                    <img src="12.png" alt="Reverend Edith Udoh">
                    <h4>Reverend Edith Udoh</h4>
                    <p><em>Pastor</em></p>
                    <p>Reverend Edith is a 2003 graduate of Law from University of Lagos...</p>
                    <div class="social-icons">
                        <a href="#"><i class="bi bi-facebook"></i></a>
                        <a href="#"><i class="bi bi-twitter"></i></a>
                        <a href="#"><i class="bi bi-linkedin"></i></a>
            ...
            <div class="col-md-4">
                <div class="pastor-card">
                    <img src="12.png" alt="Reverend Tomi Omojuwa">
                    <h4>Reverend Tomi Omojuwa</h4>
                    <p><em>Pastor</em></p>
                    <p>Rev. Tomi Omojuwa is a 1989 graduate of Economics from OAU...</p>
                    <div class="social-icons">
                        <a href="#"><i class="bi bi-facebook"></i></a>
                        <a href="#"><i class="bi bi-twitter"></i></a>
                        <a href="#"><i class="bi bi-linkedin"></i></a>
