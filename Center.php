...
<body>
    ...
    <section class="section">
        <h6>Worship with us in all our locations</h6>
        <h2 class="text-danger fw-bold">OUR LOCATIONS</h2>
        <p>Worship with us in any of our services at any of our Church locations.</p>
        <a href="Location.php" class="btn btn-custom">OUR LOCATIONS</a>

    </section>
    
    <section class="family-section">
        <div class="family-text">
            <h2 class="text-danger fw-bold">JCSIA WORSHIP CENTER </h2>
            <h3>As we embark on the journey of rebuilding JCSIA Worship Center, we stand firm on the Rock Jesus Christ. Our faith is unshaken, and our vision is clear: to restore and strengthen the house of God for His glory. This is not just about bricks and mortar but about building a place where lives are transformed, prayers are answered, and God’s presence dwells. With unwavering faith, we press on, trusting His provision and guidance.</h3>
            <button class="btn btn-dark">FIND OUT MORE</button>
        </div>
        <div class="family-image">
            <img src="https://i0.wp.com/www.christiancrossministries.org/wp-content/uploads/2018/10/06-Future-Campus.jpg?fit=1240%2C790&ssl=1" alt="Family">
        </div>
    </section>
...
<body>
    <div class="container contact-section">
        ...
        <a href="mailto:cornerstone@cllc.church">cornerstone@cllc.church</a></p>
        
        <p><strong>Phone</strong><br>
        (952) 239-9136</p>
        
        <p><strong>Worship Site</strong> <em>(Concordia St. Paul - Buetow Auditorium)</em><br>
        300 Hamline Avenue<br>
        St. Paul, MN 55104</p>
        
        <p><strong>JCSIA WORSHIP CENTER BANKERS CALOOCAN CITY </strong><br>
    
        
        <div class="row">
            <div class="col-md-6 map-container">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3858.06370709822!2d121.08242607510944!3d14.76544088574068!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397a55409cadb21%3A0x89308ffa988d134a!2sJCSIA%20Worship%20Center!5e0!3m2!1sen!2sph!4v1740020765129!5m2!1sen!2sph" width="900" height="1500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>   
            </div>
            <div class="col-md-6">
                <p class="parking-info">1474 JCSIA Worship Center Quirino Highway Bankers Village District I Zone 16 Tala, Caloocan, 1426</p>
            </div>
        </div>
